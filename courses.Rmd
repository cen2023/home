...
morning_courses <- tribble(
  ~Course, ~Instructors,
  "Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact (Part 1)", "Marcel Wolbers, Kaspar Rufibach, Gernot Wassmer and Marc Vandemeulebroecke",  
  "Implementing the estimand framework in global drug development: Application of causal inference approaches", "Mouna Akacha, Björn Bornkamp, Alex Ocampo and Jiawei Wei",
...
afternoon_courses <- tribble(
  ~Course, ~Instructors,
  "Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact (Part 2)", "Marcel Wolbers, Kaspar Rufibach, Gernot Wassmer and Marc Vandemeulebroecke",   
  "Target Trial Emulation for Causal Inference from Real-World Data", "Vanessa Didelez and Maria Geers",
  "Improving Precision and Power in Randomized Trials by Leveraging Baseline Variables", "Kelly Van Lancker, Michael Rosenblum and Josh Betz",
...
Note that courses may still be cancelled due to low registrations or moved to a different time slot up to on June 1<sup>st</sup>.
