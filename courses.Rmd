...
courses <- tribble(
  ...
  "Full-day", "No", "Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact (Part 1)", "Marcel Wolbers, Kaspar Rufibach, Gernot Wassmer and Marc Vandemeulebroecke",  
...
#  "Morning", "TBD", "Bayesian methods for missing covariates in longitudinal studies", "Nicole Erler and Emmanuel Lesaffre",
  "Morning", "TBD", "Go fastR: High Performance Computing with R", "Michael Mayer and Lukas Widmer", 
  ...
  "Afternoon", "Yes", "Model and Algorithm Evaluation in Supervised Machine Learning", "Max Westphal"
)
