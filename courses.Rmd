...
courses <- tribble(
  ...
  "Full-day", "TBD", "<a href='#bayesian-methods-for-missing-covariates-in-longitudinal-studies'>Bayesian methods for missing covariates in longitudinal studies</a>", "Nicole Erler and Emmanuel Lesaffre",
