...
morning_courses <- tribble(
  ~Course, ~Instructors,
  "Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact (Part 1)", "Marcel Wolbers, Kaspar Rufibach and Gernot Wassmer",  
  "Implementing the estimand framework in global drug development: Application of causal inference approaches", "Mouna Akacha",
  "Bayesian methods for missing covariates in longitudinal studies", "Nicole Erler and Emmanuel Lesaffre",
  "Go fastR: High Performance Computing with R", "Michael Mayer and Lukas Widmer"
)

afternoon_courses <- tribble(
  ~Course, ~Instructors,
  "Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact (Part 2)", "Marcel Wolbers, Kaspar Rufibach and Gernot Wassmer",   
  "Target Trial Emulation for Causal Inference from Real-World Data", "Didelez",
  "Improving Precision and Power in Randomized Trials by Leveraging Baseline Variables", "Van Lancker",
  "Model and Algorithm Evaluation in Supervised Machine Learning", "Max Westphal"
...
**Instructors:** Marcel Wolbers, Kaspar Rufibach and Gernot Wassmer  
...
**Instructors**: Mouna Akacha, Björn Bornkamp, Alex Ocampo and Jiawei Wei  
...
**Instructors:** Nicole Erler and Emmanuel Lesaffre
...
**Instructors:** Michael Mayer and Lukas Widmer  
...
**Instructors:** Vanessa Didelez and Maria Geers  
...
**Instructors:** Kelly Van Lancker, Michael Rosenblum and Josh Betz  
