...
<img style="float: left; margin-right: 15px; margin-bottom: 10px" width="25%" src="img/speaker/compressed/Elias_Bareinboim.jpg">

## Elias Bareinboim
**Columbia University, New York, USA**  
<br>
**Keywords**: Causal inference, data fusion, transportability, generalizability  
...
<!-- <img style="float: left; margin-right: 15px; margin-bottom: 10px" width="25%" src="img/speaker/compressed/John_O_Quigley.jpg"> -->

<!-- ## John O’Quigley -->
<!-- **University College London, UK**   -->
<!-- <br> -->
<!-- **Keywords**: Oncology, survival, non-proportional hazards, treatment effect process   -->
<!-- <br clear="both"> -->
